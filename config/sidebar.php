    ...
    */
    ...
    'menu' => [[
		...
		'sub_menu' => [[
            ...
            'url' => '/sistema/usuarios/agregar',
            'title' => 'Agregar usuario',
            'label' => 'NEW'
        ],[
            'url' => '/sistema/usuarios/lista',
            'title' => 'Lista de usuarios',
            'label' => 'NEW'
        ],[
            'url' => '/sistema/bloques/agregar',
            'title' => 'Agregar bloque',
            'label' => 'NEW'
        ],[
            'url' => '/sistema/bloques/lista',
            'title' => 'Lista de bloques',
            'label' => 'NEW'
        ],[
            'url' => '/sistema/actividades/agregar',
            'title' => 'Agregar actvidad',
            'label' => 'NEW'
        ],[
            'url' => '/sistema/actividades/lista',
